...
# initial setup
ARG user_uid=1002
ARG install_dir=/home/brewmeister/beer-garden/app
...
ENTRYPOINT ["bash"]
CMD ["-c", "source /home/brewmeister/venv/bin/activate && /opt/scripts/move_sitecustomize.sh && python bin/app.py -c ../conf/config.yaml -l ../conf/app-logging.yaml"]
